...
<head>
    ...
    <title>Registro | QR Pro Platform</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Plus Jakarta Sans', sans-serif; }
        ...
        label { display: block; margin-bottom: 0.4rem; color: #94a3b8; font-size: 0.85rem; font-weight: 500; }
...
<body>
    ...
    <div class="auth-card">
        ...
        <p class="subtitle">Únete a la nueva era de marketing digital</p>
        ...
        <form id="registerForm">
            <div class="input-group">
                ...
                <input type="text" id="name" placeholder="Ej: Victor Ontiveros" required>
            </div>
            <div class="input-group">
            ...
            <button type="submit" class="btn-primary">Crear cuenta ahora</button>
        </form>
